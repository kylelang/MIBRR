...
// runGibbs
Rcpp::List runGibbs(Eigen::MatrixXd data, int nTargets, Rcpp::List missList, Eigen::VectorXi respCounts, Eigen::VectorXd lambda1, Eigen::VectorXd lambda2, Eigen::VectorXd l1Parms, Eigen::VectorXd l2Parms, Eigen::VectorXd sigmaStarts, Eigen::MatrixXd tauStarts, Eigen::MatrixXd betaStarts, int burnSams, int totalSams, int penType, double ridge, bool verbose, bool fullBayes, bool noMiss, bool savePpSams, std::vector<unsigned int> seeds);
RcppExport SEXP _MIBRR_runGibbs(SEXP dataSEXP, SEXP nTargetsSEXP, SEXP missListSEXP, SEXP respCountsSEXP, SEXP lambda1SEXP, SEXP lambda2SEXP, SEXP l1ParmsSEXP, SEXP l2ParmsSEXP, SEXP sigmaStartsSEXP, SEXP tauStartsSEXP, SEXP betaStartsSEXP, SEXP burnSamsSEXP, SEXP totalSamsSEXP, SEXP penTypeSEXP, SEXP ridgeSEXP, SEXP verboseSEXP, SEXP fullBayesSEXP, SEXP noMissSEXP, SEXP savePpSamsSEXP, SEXP seedsSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(runGibbs(data, nTargets, missList, respCounts, lambda1, lambda2, l1Parms, l2Parms, sigmaStarts, tauStarts, betaStarts, burnSams, totalSams, penType, ridge, verbose, fullBayes, noMiss, savePpSams, seeds));
