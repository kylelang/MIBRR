...
runGibbs <- function(data, nTargets, missList, respCounts, lambda1, lambda2, l1Parms, l2Parms, sigmaStarts, tauStarts, betaStarts, burnSams, totalSams, penType, ridge, verbose, fullBayes, noMiss, savePpSams, useBetaMeans, finalRep, seeds) {
    .Call('_MIBRR_runGibbs', PACKAGE = 'MIBRR', data, nTargets, missList, respCounts, lambda1, lambda2, l1Parms, l2Parms, sigmaStarts, tauStarts, betaStarts, burnSams, totalSams, penType, ridge, verbose, fullBayes, noMiss, savePpSams, useBetaMeans, finalRep, seeds)
}
