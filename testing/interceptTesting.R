...
beta00 <- apply(bl00$beta[-1, ], 2, median)
beta01 <- apply(bl01$beta[-1, ], 2, median)
...
beta10 <- apply(getParams(bl10, "y")$beta, 2, median)
beta11 <- apply(getParams(bl11, "y")$beta, 2, median)

lm1 <- lm(y ~ ., data = dat0)

crossprod(beta00) / crossprod(coef(lm1)[-1])
crossprod(beta01) / crossprod(coef(lm1)[-1])

crossprod(beta10) / crossprod(coef(lm1)[-1])
crossprod(beta11[-1]) / crossprod(coef(lm1)[-1])
