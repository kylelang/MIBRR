...
std::vector<double> drawGig(int, double, double, double);
...
static void _rgig_ROU_noshift(std::vector<double>&,
			      int,
			      double,
			      double,
			      double,
...
static void _rgig_newapproach1(std::vector<double>&,
			       int,
			       double,
			       double,
			       double,
...
static void _rgig_ROU_shift_alt(std::vector<double>&,
				int,
				double,
				double,
				double,
